...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("SpawnEnemyTwo", 3f, 4f);
        InvokeRepeating("SpawnEnemyThree", 1.5f, 2f);
    ...
    void SpawnEnemyTwo()
    {
        Instantiate(enemyTwoPrefab, new Vector3(Random.Range(-5, 5), 7.5f, 0), Quaternion.Euler(0, 0, 180));
    }
     void SpawnEnemyThree()
    {
        Instantiate(enemyThreePrefab, new Vector3(Random.Range(-7, 7), 7.5f, 0), Quaternion.Euler(0, 0, 180));
    }
